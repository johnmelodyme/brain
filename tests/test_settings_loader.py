...
from brain.core.Models import Singleton
from brain.core.Models import Resources
from brain.core.Models.settings.Options import Options
from brain.core.Models.settings.Player import Player
from brain.core.Models.settings.RestAPI import RestAPI
from brain.core.Models.settings.Settings import Settings
from brain.core.Models.settings.Stt import Stt
from brain.core.Models.settings.Trigger import Trigger
from brain.core.Models.settings.Tts import Tts
...
class TestSettingLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.settings_dict = {
            ...
            'triggers': [{'snowboy': {'pmdl_file': 'trigger/snowboy/resources/brain-FR-6samples.pmdl'}}],
            'default_player': 'mplayer',
            'players': [{'mplayer': {}}, {'pyalsaaudio': {"device": "default"}}],
            'speech_to_text': [{'google': {'language': 'fr-FR'}}],
            'cache_path': '/tmp/brain_tts_cache',
            'resource_directory': {
                'stt': '/tmp/brain/tests/brain_resources_dir/stt',
                'tts': '/tmp/brain/tests/brain_resources_dir/tts',
                'neuron': '/tmp/brain/tests/brain_resources_dir/neurons',
                'trigger': '/tmp/brain/tests/brain_resources_dir/trigger'},
    ...
    def tearDown(self):
        # Cleanup
        shutil.rmtree('/tmp/brain/tests/brain_resources_dir')
    ...
    def test_get_settings(self):
        ...
        trigger1 = Trigger(name="snowboy",
                           parameters={'pmdl_file': 'trigger/snowboy/resources/brain-FR-6samples.pmdl'})
        ...
        resources = Resources(neuron_folder="/tmp/brain/tests/brain_resources_dir/neurons",
    ...
    def test_get_cache_path(self):
        expected_cache_path = '/tmp/brain_tts_cache'
        sl = SettingLoader(file_path=self.settings_file_to_test)
