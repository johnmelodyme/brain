...
from brain.core.NeuronModule import NeuronModule, TemplateFileNotFoundException, TTSModuleNotFound
...
class TestNeuronModule(unittest.TestCase):
    ...
    def test_get_audio_from_stt(self):
        ...
        with mock.patch("brain.core.OrderListener.start") as mock_orderListener_start:
            with mock.patch("brain.core.OrderListener.join"):
                def callback():
                    pass
