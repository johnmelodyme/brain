...
from brain.core.ConfigurationManager import BrainLoader
from brain.core.Lifo.LIFOBuffer import Serialize, SynapseListAddedToLIFO
...
class TestLIFOBuffer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if "/tests" in os.getcwd():
            self.brain_to_test = os.getcwd() + os.sep + "synapses/lifo_buffer_test_brain.yml"
        else:
            self.brain_to_test = os.getcwd() + os.sep + "tests/synapses/lifo_buffer_test_brain.yml"
