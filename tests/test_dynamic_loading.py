...
class TestDynamicLoading(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # get the neuron dir
        self.neurons_dir = os.path.normpath(root_dir + os.sep + "brain/neurons")

        # get stt dir
        self.stt_dir = os.path.normpath(root_dir + os.sep + "brain/stt")

        # get tts dir
        self.tts_dir = os.path.normpath(root_dir + os.sep + "brain/tts")

        # get trigger dir
        self.trigger_dir = os.path.normpath(root_dir + os.sep + "brain/trigger")
    ...
    def dynamic_import(self, package_name, module_name):
        ...
        :return:
        """
        module_name_with_path = "brain." + package_name + "." + module_name.lower() + "." + module_name.lower()
