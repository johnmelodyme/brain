...
from brain._version import version_str
...
class TestRestAPI(LiveServerTestCase):
    ...
    def test_get_main_page(self):
        ...
        expected_content = {
            "Brain.ai version": "%s" % version_str
        }
    ...
    def test_convert_to_wav(self):
        ...
        with mock.patch("os.system") as mock_os_system:
            ...
            temp_file = "/tmp/brain/tempfile.wav"  # tempfile.NamedTemporaryFile(suffix=".wav")
            ...
            temp_file = "/tmp/brain/tempfile.amr"  # tempfile.NamedTemporaryFile(suffix=".wav")
            expected_result = "/tmp/brain/tempfile.wav"
            result_file = FlaskAPI._convert_to_wav(temp_file)
