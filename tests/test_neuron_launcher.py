...
from brain.core.Models.settings.Resources import Resources
from brain.core.NeuronLauncher import NeuronLauncher, NeuronParameterNotAvailable
from brain.core.ConfigurationManager import SettingLoader

from brain.core.Models.Neuron import Neuron
...
class TestNeuronLauncher(unittest.TestCase):
    ...
    def test_launch_neuron(self):
        ...
        with mock.patch("brain.core.Utils.get_dynamic_class_instantiation") as mock_get_class_instantiation:
    ...
    def test_start_neuron(self):
        ...
        with mock.patch("brain.core.NeuronLauncher.launch_neuron") as mock_launch_neuron_method:
    ...
    def test_replace_brackets_by_loaded_parameter(self):
        ...
        list_reserved_keys = ["say_template", "file_template", "brain_memory", "from_answer_link"]
