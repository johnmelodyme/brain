...
from brain.core.Models import Singleton, Signal
...
from brain.core.Models.Brain import Brain
...
class TestBrainLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if "/tests" in os.getcwd():
            self.brain_to_test = os.getcwd() + os.sep + "synapses/brain_test.yml"
        else:
            self.brain_to_test = os.getcwd() + os.sep + "tests/synapses/brain_test.yml"
