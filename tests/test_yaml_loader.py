...
from brain.core.ConfigurationManager.YAMLLoader import YAMLFileNotFound, YAMLLoader
...
class TestYAMLLoader(unittest.TestCase):
    ...
    def test_get_config(self):
        ...
        if "/tests" in os.getcwd():
            valid_file_path_to_test = os.getcwd() + os.sep + "synapses/brain_test.yml"
        else:
            valid_file_path_to_test = os.getcwd() + os.sep + "tests/synapses/brain_test.yml"

        invalid_file_path = "synapses/non_existing_brain.yml"
        expected_result = [
