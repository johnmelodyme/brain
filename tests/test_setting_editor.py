...
from brain import SettingLoader
from brain.core.ConfigurationManager import SettingEditor
...
class TestSettingEditor(unittest.TestCase):
    ...
    def test_set_mute_status(self):
        with mock.patch("brain.core.ConfigurationManager.SettingLoader") as mock_setting_loader:
