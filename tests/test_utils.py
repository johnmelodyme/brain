...
from brain.neurons.say.say import Say
...
class TestUtils(unittest.TestCase):
    ...
    def test_get_current_file_parent_parent_path(self):
        ...
        """
        path_to_test = "../brain/core/Utils"
        expected_result = os.path.normpath("../brain")
    ...
    def test_get_real_file_path(self):
        ...
        file_name = "test_real_file_path"
        path_to_test = os.path.join(dir_path, file_name)
        expected_result = os.path.normpath(os.getcwd() + os.sep + os.pardir + os.sep + "brain" + os.sep + file_name)
        if not os.path.exists(dir_path):
            os.makedirs(dir_path)
