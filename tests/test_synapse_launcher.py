...
from brain.core import LifoManager
from brain.core.Models import Brain, Signal, Singleton
from brain.core.Models.MatchedSynapse import MatchedSynapse
from brain.core.Models.settings.Settings import Settings
from brain.core.SynapseLauncher import SynapseLauncher, SynapseNameNotFound

from brain.core.Models import Neuron
from brain.core.Models import Synapse
...
class TestSynapseLauncher(unittest.TestCase):
    ...
    def test_run_matching_synapse_from_order(self):
        ...
        Singleton._instances = dict()
        LifoManager.clean_saved_lifo()
        with mock.patch("brain.core.HookManager.on_order_not_found") as mock_hook:
        ...
        Singleton._instances = dict()
        with mock.patch("brain.core.Lifo.LIFOBuffer.execute"):
            with mock.patch("brain.core.HookManager.on_order_found") as mock_hook:
                order_to_match = "this is the second sentence"
