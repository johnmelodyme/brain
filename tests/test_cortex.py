...
from brain.core.Cortex import Cortex
...
class TestCortex(unittest.TestCase):
    ...
    def test_save_neuron_parameter_in_memory(self):
        ...
        Cortex.save_neuron_parameter_in_memory(brain_memory_dict=dict_val_to_save,
        ...
        # test with an empty list of parameter to save (no brain_memory set)
        self.setUp()  # clean
