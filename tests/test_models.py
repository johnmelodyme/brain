...
from brain.core.Models.Signal import Signal
...
from brain.core import LIFOBuffer
from brain.core.Models.settings.Settings import Settings

from brain.core.Models import Neuron, Synapse, Brain, Resources, Singleton

from brain.core.Models.APIResponse import APIResponse
from brain.core.Models.MatchedSynapse import MatchedSynapse
...
class TestModels(unittest.TestCase):
    ...
    def test_Dna(self):
        # create DNA object
        dna1 = Dna(name="dna1", module_type="neuron", author="brain",
                   brain_supported_version="0.1.4", tags="test")

        dna2 = Dna(name="dna2", module_type="neuron", author="community",
                   brain_supported_version="0.1.2", tags="other")

        # this dna is exactly the same as the first one
        dna3 = Dna(name="dna1", module_type="neuron", author="brain",
                   brain_supported_version="0.1.4", tags="test")

        expected_result_serialize = {
            'brain_supported_version': '0.1.4',
            'tags': 'test',
            'type': 'neuron',
            'name': 'dna1',
            'author': 'brain'
    ...
    def test_MatchedSynapse(self):
        ...
        with mock.patch("brain.core.NeuronParameterLoader.get_parameters") as mock_get_parameters:
