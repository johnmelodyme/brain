# used to build the last brain dev version with python 3
# docker build --force-rm=true -t brain-ubuntu1604-python3 -f docker/ubuntu_16_04_python3.dockerfile .
# docker run -it --rm brain-ubuntu1604-python3

FROM ubuntu:16.04

ENV no_proxy="127.0.0.1,localhost,brain.en"
...
ADD tests/docker/clone_and_test_python3.sh /home/tester/clone_and_test_python3.sh
