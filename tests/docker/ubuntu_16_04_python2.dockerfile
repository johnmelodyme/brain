...
ADD tests/docker/clone_and_test_python2.sh /home/tester/clone_and_test_python2.sh
RUN chown tester /home/tester/clone_and_test_python2.sh

USER tester
WORKDIR /home/tester

# run tests
CMD ./clone_and_test_python2.sh
